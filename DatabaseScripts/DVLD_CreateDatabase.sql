...
/****** Object:  Database [DVLD]    Script Date: 6/14/2025 12:03:44 AM ******/
CREATE DATABASE [DVLD]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DVLD', FILENAME = N'C:\SQLData\DVLD.mdf' , SIZE = 73728KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
...
USE [DVLD]
GO
INSERT INTO [dbo].[People] VALUES('Admin','Admin','Admin',Null,'Admin','2000-10-12','Admin','0000',NULL,1,NULL)
INSERT INTO [dbo].[Users] VALUES(3026,'Admin','Admin',1)